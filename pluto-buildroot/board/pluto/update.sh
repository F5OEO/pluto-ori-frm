...
do
 if [[ -r ${file} ]]
  then
	...
	## myscript.sh
	if [[ -s /mnt/msd/myscript.sh ]]
    then
            cp /mnt/msd/myscript.sh /mnt/jffs2
            chmod +x /mnt/jffs2/myscript.sh
            rm /mnt/msd/myscript.sh
            cp /mnt/jffs2/myscript.sh /mnt/msd/actual_myscript.sh
    fi
