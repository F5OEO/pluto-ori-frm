...
local fm_mod = radio.FrequencyModulatorBlock(0.1)
...
local filter2 = radio.ComplexBandpassFilterBlock(128, {0, 5000})
...
local wav2iq = radio.CompositeBlock()
      wav2iq:connect(source, af_filter, fm_mod, filter2, interpolator, sinkiio)
